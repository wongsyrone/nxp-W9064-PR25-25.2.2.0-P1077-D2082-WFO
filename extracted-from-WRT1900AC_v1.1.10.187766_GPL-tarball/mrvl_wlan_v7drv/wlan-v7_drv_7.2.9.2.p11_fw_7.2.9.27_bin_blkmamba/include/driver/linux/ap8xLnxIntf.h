...
#define MAX_CARDS_SUPPORT NUMOFPHYS
...
#ifdef NOEEPROM_SUPPORT
#define EEPROM_ON_FILE_MAX_SIZE     4096
...
{
	Bool_t bstaCreated;
	Bool_t bAllowBssStart;
	UINT32 RepeaterChnlWidth;
	UINT32 FreqBand;	
}RepeaterInfo_t;
...
#endif    
#ifdef HISTOGRAM_FROM_RATE_FEEDBACK
	WLAN_RATE_HIST rxRateHistogram;
	WLAN_RATE_HIST txRateHistogram[MAX_STNS];
#endif
#ifdef RX_FRAME_TRACE
	WLAN_TRACE_HIST rxFrameTraceHistogram;
#endif
	UINT8 ldpcdisable;
	RepeaterInfo_t RepeaterInfo;
};
struct wlprivate {
