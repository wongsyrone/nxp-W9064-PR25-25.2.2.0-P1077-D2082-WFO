 ...
 */
static SHAL_INLINE void LIST_init(LIST_ELEM_st * list)
{
	list->next = list;
	list->prev = list;
}
 ...
 */
static SHAL_INLINE void LIST_elemInit(LIST_ELEM_st * elem)
{
	elem->next = 0;
	elem->prev = 0;
}
 ...
 */
static SHAL_INLINE BOOL LIST_isEmpty(LIST_ELEM_st * list)
{
 ...
 */
static SHAL_INLINE BOOL LIST_isNotEmpty(LIST_ELEM_st * list)
{
 ...
 */
static SHAL_INLINE void LIST_insertBefore(LIST_ELEM_st * list, LIST_ELEM_st * elem, LIST_ELEM_st * newElem)
{
 ...
 *  @param  newElem New element to insert in the list.
 */
static SHAL_INLINE void LIST_insertAfter(LIST_ELEM_st * list, LIST_ELEM_st * elem, LIST_ELEM_st * newElem)
{
	SHAL_ASSERT(newElem != list);
 ...
 */
static SHAL_INLINE void LIST_addHead(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
 ...
 *  @param  elem New element to insert in the list.
 */
static SHAL_INLINE void LIST_addTail(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
 ...
 */
static SHAL_INLINE LIST_ELEM_st *LIST_peekFirst(LIST_ELEM_st * list)
{
	return (list->next);
}
 ...
 */
static SHAL_INLINE LIST_ELEM_st *LIST_peekNext(LIST_ELEM_st * elem)
{
	return (elem->next);
}
 ...
 *
 */
static SHAL_INLINE LIST_ELEM_st *LIST_peekLast(LIST_ELEM_st * list)
{
	return (list->prev);
}
...
static SHAL_INLINE void LIST_remove(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
 ...
 */
static SHAL_INLINE void LIST_move(LIST_ELEM_st * dstList, LIST_ELEM_st * elem)
{
 ...
 *  @return The first element of the list.
 */
static SHAL_INLINE LIST_ELEM_st *LIST_getFirst(LIST_ELEM_st * list)
{
	LIST_ELEM_st *elem;
 ...
 */
static SHAL_INLINE BOOL LIST_isElemLinked(LIST_ELEM_st * elem)
{
	return (elem->next != 0);
}
 ...
 */
static SHAL_INLINE BOOL LIST_isFirst(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
	SHAL_ASSERT(elem != list);
 ...
 */
static SHAL_INLINE BOOL LIST_isLast(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
	SHAL_ASSERT(elem != list);
 ...
 *  @endcode
 */
static SHAL_INLINE BOOL LIST_isEnd(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
	return (elem == list);
}
 ...
 *
 */
static SHAL_INLINE BOOL List_Find(LIST_ELEM_st * list, LIST_ELEM_st * elem)
{
	LIST_ELEM_st *cur;
 ...
 */
static SHAL_INLINE void LIST_appendList(LIST_ELEM_st * destList, LIST_ELEM_st * list)
{
	LIST_ELEM_st *first;
	LIST_ELEM_st *last;
...
static SHAL_INLINE BOOL LIST_appendListCheck(LIST_ELEM_st * destList, LIST_ELEM_st * list)
{
	LIST_ELEM_st *first;
	LIST_ELEM_st *last;
	LIST_ELEM_st *destLast;
