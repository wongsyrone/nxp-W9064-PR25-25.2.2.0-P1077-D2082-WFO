...
typedef struct STA_RX_A_CONTROL_UPH_st {
	U8 hdrmPwr:5;		//0~31 db
	U8 minTxPwer:1;
	U8 hdrmShown:1;
	U8 rsvd:1;
} STA_RX_A_CONTROL_UPH_st;
...
// DW46
	...
	U8 delta_snr;		///< P10 Delta SNR for Feedback
...
// DW48
	...
	U8 USPInfo;		//trigger;       //b[0-3]: USP ACs triggered, b[4-7]: USP is about to end. QoS NULL/ESOP=1 is added.
// DW49
	U8 qosInfo;
	U8 bssColor;
	U16 SeqCtrl;
...
// DW55
	...
	U16 ulmu_disable:1;	//From A-Control OMI
	U16 ulmu_data_disable:1;	//From A-Control OMI
	U16 supp_he_htc:1;
	...
	U16 tf_cnt_idx:1;
	U16 rxbw:2;
	U16 P10_SNR_Inbalance_En:1;
	U16 rsvd2:5;

	U8 rxmcs:4;
	U8 rxnss:2;
	U8 ctrl_port_state:2;
	S8 rssi;
// DW56 - DW57
	union {
...
//DW61
	S8 he_rssi;
	STA_RX_A_CONTROL_UPH_st he_uph[2];
	S8 rx_rssi;
} SMAC_STA_ENTRY_st;
