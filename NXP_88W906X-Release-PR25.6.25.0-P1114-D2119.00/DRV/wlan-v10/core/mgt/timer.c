...
{
	if (timer_pending(me) || me->function != NULL)
		return;
	init_timer(me);
	me->function = NULL;
}
...
/*!
* Remove a timer and wait for the handler to finish
* @param me Pointer to the timer
*
