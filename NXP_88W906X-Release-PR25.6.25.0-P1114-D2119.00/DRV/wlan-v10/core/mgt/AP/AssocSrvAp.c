...
void AssocSrvApCtor(AssocSrvAp * me)
{
	...
	mhsm_add(&me->Assoc_Srv_Ap, &me->sTop, (MhsmFcnPtr) Assoc_Srv_Ap_Handle);
	mhsm_add(&me->Assoc_Idle, &me->Assoc_Srv_Ap, (MhsmFcnPtr) Assoc_Idle_Handle);
	mhsm_add(&me->Wait_Assoc_Rsp, &me->Assoc_Srv_Ap, (MhsmFcnPtr) Wait_Assoc_Rsp_Handle);
	mhsm_add(&me->Wait_ReAssoc_Rsp, &me->Assoc_Srv_Ap, (MhsmFcnPtr) Wait_ReAssoc_Rsp_Handle);
}
