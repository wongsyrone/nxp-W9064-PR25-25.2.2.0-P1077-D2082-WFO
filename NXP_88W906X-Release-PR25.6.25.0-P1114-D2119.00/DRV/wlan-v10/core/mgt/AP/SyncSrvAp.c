...
void SyncSrvCtor(SyncSrvAp * me)
{
	...
	mhsm_add(&me->Sync_Srv_Ap, &me->sTop, (MhsmFcnPtr) Sync_Srv_Ap_Handle);
	mhsm_add(&me->No_Bss, &me->Sync_Srv_Ap, (MhsmFcnPtr) No_Bss_Handle);
	mhsm_add(&me->Bss, &me->Sync_Srv_Ap, (MhsmFcnPtr) Bss_Handle);
	mhsm_add(&me->Sta_Active, &me->Sync_Srv_Ap, (MhsmFcnPtr) Sta_Active_Handle);
}
