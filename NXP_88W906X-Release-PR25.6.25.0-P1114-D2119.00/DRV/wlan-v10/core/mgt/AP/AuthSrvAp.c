...
extern void AuthReqSrvApCtor(AuthReqSrvAp * me)
{
	...
	mhsm_add(&me->Auth_Req_Srv_Ap, &me->sTop, (MhsmFcnPtr) Auth_Req_Srv_Ap_Handle);
	mhsm_add(&me->Auth_Req_Idle, &me->Auth_Req_Srv_Ap, (MhsmFcnPtr) Auth_Req_Idle_Handle);
	mhsm_add(&me->Wait_Auth_Seq2, &me->Auth_Req_Srv_Ap, (MhsmFcnPtr) Wait_Auth_Seq2_Handle);
	mhsm_add(&me->Wait_Auth_Seq4, &me->Auth_Req_Srv_Ap, (MhsmFcnPtr) Wait_Auth_Seq4_Handle);
	TimerInit(&me->timer);
}
...
extern void AuthRspSrvApCtor(AuthRspSrvAp * me)
{
	...
	mhsm_add(&me->Auth_Rsp_Srv_Ap, &me->sTop, (MhsmFcnPtr) Auth_Rsp_Srv_Ap_Handle);
	mhsm_add(&me->Auth_Rsp_Idle, &me->Auth_Rsp_Srv_Ap, (MhsmFcnPtr) Auth_Rsp_Idle_Handle);
	mhsm_add(&me->Wait_Chal_Rsp, &me->Auth_Rsp_Srv_Ap, (MhsmFcnPtr) Wait_Chal_Rsp_Handle);
	TimerInit(&me->timer);
}
