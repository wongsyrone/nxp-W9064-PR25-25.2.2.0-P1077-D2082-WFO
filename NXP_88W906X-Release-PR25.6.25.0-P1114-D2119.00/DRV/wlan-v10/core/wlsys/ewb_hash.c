 ...
 *
 **************************************************************************/
int wetAddHashEntry(hash_entry * currentEntry, unsigned long key, unsigned char *clntMac)
{
	hash_entry *nwEntry;
	...
	if ((currentEntry->nxtEntry = (unsigned char *)(wl_kmalloc(sizeof(hash_entry), GFP_ATOMIC)))
	    == NULL) {
		return -1;
	}
