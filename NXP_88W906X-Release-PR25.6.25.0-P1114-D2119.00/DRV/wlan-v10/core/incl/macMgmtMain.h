...
extern int parsing_rsn_ie(UINT8 * pData, IEEEtypes_RSN_IE_WPA2_t * pRSNE, UINT8 * mfpc, UINT8 * mfpr);
#else
extern int parsing_rsn_ie(UINT8 * pData, IEEEtypes_RSN_IE_WPA2_t * pRSNE);
#endif
