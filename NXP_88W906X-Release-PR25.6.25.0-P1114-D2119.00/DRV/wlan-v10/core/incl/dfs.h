...
#ifdef RADAR_SCANNER_SUPPORT
#ifdef CONCURRENT_DFS_SUPPORT
	void (*scnr_ctl_evt) (struct net_device * dev, SCANNER_CTL_EVENT event, DFS_STATE dfs_status, UINT8 IsFromAux);
#endif				/* CONCURRENT_DFS_SUPPORT */
	void (*scnr_send_evt) (struct net_device * dev, SCANNER_CTL_EVENT event, DFS_STATE dfs_status);
...
extern void dfsTrace(struct net_device *netdev, UINT8 state, UINT8 event, DfsChanInfo * pInfo, UINT32 tag);
