...
extern WL_STATUS os_TaskCreate(os_Id_t * TaskId,
			       os_TaskEntry_t * Entry_p, os_Addrword_t Data, char *TaskName_p, os_Ucount32 StackSize, os_Addrword_t Priority);
 ...
 *
 *****************************************************************************/
extern WL_STATUS os_InterruptCreate(os_Id_t InterruptId, os_Vector_t Vector, os_Priority_t Priority, os_ISR_t * Isr_p, os_DSR_t * Dsr_p);
 ...
 *
 *****************************************************************************/
extern void os_EventTrigger(os_Id_t EventId, os_IndicatedEvents_t EventsToTrigger);
 ...
 *
 *****************************************************************************/
extern os_IndicatedEvents_t os_EventWait(os_Id_t EventId, os_IndicatedEvents_t EventsToWaitFor, os_EventMode_t Mode);
 ...
 *
 *****************************************************************************/
extern void os_EventClear(os_Id_t EventId, os_IndicatedEvents_t EventsToClear);
 ...
 *
 *****************************************************************************/
extern WL_STATUS os_TimerCreate(os_Id_t TimerId, os_Alarm_t * TimerFunc_p, os_Addrword_t Data);
 ...
 *
 *****************************************************************************/
extern void os_TimerInit(os_Id_t TimerId, os_TickCount_t Trigger, os_TickCount_t Interval);
