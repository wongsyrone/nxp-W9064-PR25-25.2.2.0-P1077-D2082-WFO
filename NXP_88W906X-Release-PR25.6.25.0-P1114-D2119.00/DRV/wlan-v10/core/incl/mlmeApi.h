...
//Need Cleanup:: Defined else where, but will cause compile error if included
...
extern void mlmeApiUpdateLinkStatus(vmacStaInfo_t * vStaInfo_p, UINT8 linkId);
...
extern struct sk_buff *mlmeApiPrepMgtMsg2_sta(vmacApInfo_t * vmacSta_p, UINT32 Subtype, IEEEtypes_MacAddr_t * DestAddr, UINT16 size);
...
extern BOOLEAN mlmeApiCreatePeerStationInfoForWBMode(IEEEtypes_MacAddr_t * staMacAddr,
						     ...
						     IEEEtypes_ExtSuppRatesElement_t * ExtRates_p, phyMacId_t phyHwMacIndx);
...
extern vmacEntry_t *smeInitParentSession(UINT8 phyMacIndx, UINT8 * macAddr, trunkId_t trunkId, void *callBack_fp, void *privInfo_p);
...
extern vmacEntry_t *smeStartChildSession(UINT8 phyMacIndx,
					 UINT8 * macAddr, trunkId_t trunkId, void *callBack_fp, UINT32 controlParam, void *privInfo_p);
...
extern int wlset_rateSupport(MIB_802DOT11 * mib);
...
#ifdef SOC_W906X
extern int get_he_peer_nss(he_mcs_nss_support_t * mcs_nss_set_remote_p);
#endif
