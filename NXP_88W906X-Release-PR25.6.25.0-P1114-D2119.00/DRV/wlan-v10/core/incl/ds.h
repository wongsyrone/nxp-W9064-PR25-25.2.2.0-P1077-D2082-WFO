...
#ifdef SOC_W906X
extern int ieee80211_input(struct net_device *dev, struct sk_buff *skb, u_int32_t rssi, RssiPathInfo_t * rssiPaths, wlrxdesc_t * pCfhul,
			   u_int8_t isFirstMsdu, u_int16_t stnid, u_int8_t LMFbit);
extern struct sk_buff *ieee80211_encap(struct sk_buff *skb, struct net_device *netdev, BOOLEAN eap, void *pStaInfo);
#else
