...
extern void MAP_tlv_Query_process(vmacApInfo_t * vmacSta_p, MultiAP_TLV_Element_t * map_tlv);
extern void MAP_tlv_Resp_process(vmacApInfo_t * vmacSta_p, void *msg_data, IEEEtypes_MacAddr_t * sta_mac_addr_p, UINT8 status);

extern SINT32 EM_get_cac_status(UINT8 * buf, UINT8 log);
extern void EM_CAC_Scan(vmacApInfo_t * vmacSta_p, UINT8 op_class, UINT8 ch, UINT8 enable);
