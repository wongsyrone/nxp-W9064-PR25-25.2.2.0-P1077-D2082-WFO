...
typedef enum {
	QOS_TS_ADMITTED,
	QOS_TS_PENDING,
	QOS_TS_TIMEOUT,		/* reserve for supporting ADDTS request */
	QOS_TS_REJECTED		/* reserve for supporting ADDTS request */
} QOS_TS_Status_e;
...
#ifdef WMM_AC_EDCA
extern UINT16 ProcessADDTSRequest_WFA(vmacApInfo_t * vmacSta_p, IEEEtypes_WFA_ADDTS_Req_t * AddTSReq_p,
				      IEEEtypes_MacAddr_t * pStaAddr, UINT16 Aid, UINT32 * TspecIndx, UINT8 ClientMode, UINT16 * pMediumTime);
#endif
...
extern void SendGroupIDMgmtframe(vmacApInfo_t * vmacSta_p, IEEEtypes_MacAddr_t StaAddr, UINT8 gid, UINT8 userposition);
extern UINT8 AccCategoryQ[8];
#ifdef SOC_W8964
extern struct qos_ts_info QosTsData[];
#endif
#endif				//QOS_FEATURE
#endif
