...
extern int wldbgCoreDump(struct notifier_block *nb, unsigned long action, void *data);
extern void wldbgCoreMonitor(struct net_device *netdev, UINT32 enable, UINT32 bitmap, UINT32 format);
extern u64 dump_file(UINT8 * valbuf, UINT32 length, UINT8 * fname, UINT32 append);
extern u64 dump_binfile(UINT8 * valbuf, UINT32 length, UINT8 * fname, UINT32 append);
extern u64 read_binfile(UINT8 * valbuf, UINT32 length, UINT8 * fname);
