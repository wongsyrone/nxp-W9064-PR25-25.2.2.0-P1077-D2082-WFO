...
*/
#ifdef __aarch64__
#if (!defined(ECL_WPA) && defined(CONFIG_ARM)) && !defined(MV_CPU_BE)
...
#endif
#else
#if !defined(ECL_WPA) && !defined(MV_CPU_BE)
#define ROR32(_out,_in,len) __asm("mov	%0, %1, ror %2\n" : "=r" (_out) : "r" (_in), "g" (len))
#define ROL32(out,in,len) ROR32(out,in,(32-len))
#else
#define ROL32(B,A,n) B = (((A) << (n)) | ((A) >> (32-(n))))
...
#else
void ComputeEAPOL_MIC(vmacApInfo_t * vmacSta_p, UINT8 * data, UINT16 data_length, UINT8 * MIC_Key, UINT8 MIC_Key_length, UINT8 * computed_MIC);
void genetate_PTK(vmacApInfo_t * vmacSta_p, IEEEtypes_MacAddr_t * pAddr1, IEEEtypes_MacAddr_t * pAddr2, UINT8 * pNonce1, UINT8 * pNonce2, UINT8 *);
#endif
...
inline void MichaelTx(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);

inline void MichaelRx(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);
#ifdef STA_QOS
inline void MichaelRxSta(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);
inline void MichaelTxSta(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);

#else
inline void MichaelRxSta(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res);
inline void MichaelTxSta(const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res);
#endif
#ifdef STA_QOS
extern void (*MichaelRxStaFp) (const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);
extern void (*MichaelTxStaFp) (const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res, UINT32 prio);

#else
extern void (*MichaelRxStaFp) (const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res);
extern void (*MichaelTxStaFp) (const IEEEtypes_GenHdr_t * pHdr, const UINT32 * Key, UINT32 * data, UINT32 * res);
#endif
