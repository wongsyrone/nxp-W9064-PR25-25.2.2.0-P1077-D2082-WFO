...
UINT16 AddExtended_Cap_IE(vmacApInfo_t * vmacSta_p, IEEEtypes_Extended_Cap_Element_t * pNextElement);
#ifdef SOC_W906X
extern UINT8 Add_Mbssid_IE(vmacApInfo_t * vmacSta_p, IEEEtypes_Mbssid_Element_t * pNextElement);
#endif
...
extern UINT16 Add_MultiAP_IE(vmacApInfo_t * vmacSta_p, IEEEtypes_InfoElementHdr_t * pNextElement, UINT8 protocol_type);
...
extern UINT16 Build_IE_HE_OP(vmacApInfo_t * vmacSta_p, UINT8 * IE_p, UINT8 vhtopie_present);
