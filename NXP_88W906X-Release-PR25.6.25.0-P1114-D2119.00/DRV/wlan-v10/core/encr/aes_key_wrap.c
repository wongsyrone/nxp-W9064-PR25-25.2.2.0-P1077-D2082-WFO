...
extern void AES_Encrypt(const UINT32 in_blk[4], UINT32 out_blk[4], UINT32 keys[]);
extern void AES_DecryptWrap(const UINT32 in_blk[4], UINT32 out_blk[4], UINT32 enc_keys[], UINT32 dec_keys[]);
extern void AES_SetKeyWrap(const UINT32 in_key[], UINT32 enc_key[], UINT32 dec_key[]);
