...
#define  BCN_STUCK_MAX_RXLOAD 95
#define  BCN_STUCK_CCA_BLOCK 50	//  percentage: (txBcnAbort' x 4) / availSlotCnt'
#define  BCN_STUCK_NAV_BLOCK 50	//  percentage: (txBcnAbort' x 4 + navBlockCnt') / availSlotCnt'
...
#define MON_SMAC_RXAMSDU_QFULL	(1<<16)

#define WLMON_DEFAULT_DISABLE    0
#define WLMON_DEFAULT_ENABLE     1

#define WLMON_DEFAULT_HMMASK     (MON_SMAC_STUCK|MON_SMAC_BCN_STUCK|MON_SMAC_RX_STUCK|\
		MON_PFW_ALIVE_CNTS|MON_DRV_ERR_CNTS|MON_DRV_BMQ_RESOURCE|MON_DRV_CMD|\
		MON_MOCHI_ERROR|MON_TEMPERATURE|MON_SMAC_RXAMSDU_QFULL)
...
typedef struct {
	...
	UINT32 smaceop2_Q2RxAmsduStuck;
	UINT32 smacRxAMSDU_QFullCnt;
} smac_mon;
